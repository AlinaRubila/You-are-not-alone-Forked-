label timur_cp3:
    ...
    if helpedWithRepair == False:
        ...
        #спрайт гг обычный в пижаме
        show mc normal home at left2 with dissolve

        mc "Что-то случилось?"

        #спрайт Тимур обычный в пижаме
        show timur normal home at right2 with dissolve
        ...
        #спрайт Тимур задумчивый в пижаме
        show timur thoughtful home at right2 with dissolve
        ...
        #фон сменяется на темноту с эффектом моргания (он есть в предыдущей главе)
    ...
    if relate_timur < 20:
        ...
        #на диске в папке с Тимуровскими цг есть эта самая фотография с посвята, звук перелиста бумаги (он есть в файлах)
        play sound bumaga
        scene cj_photo with dissolve
        #я думаю, тут должна начать играть композиция EvaMemories
        play music EvaMemories
        ...
        #эмбиент комнаты и её фон без обоев
        ...
        #на диске должна быть цг с блокнотом Тимура в его папке, его нужно сюда впендюрить
