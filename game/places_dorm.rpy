label Kitchen:
    ...
    "Справа от плиты гаходился стол с микроволновкой, а под ним было уже почти полностью забитое мусорное ведро. Мусор выносят так же по графику."
...
label Laundry:
    ...
    "Комендант прошла со мной в помещение, где стояло четыре стиральных машины, а сверху над ними были сушилки для белья. Мне кажется, это довольно удобно. Жаль, конечно, что стиралка не в комнате, но то, что она хотя бы есть, не может не радовать."
