...
label timur_cp2:
    ...
    if helpedWithRepair:
        ...
        hide mc smile homea with dissolve
        hide timur smile homea with dissolve
        #убираем спрайты - здесь будет ЦГ
        ...
        scene black with dissolve
        "В моей голове пронеслась мысль: «И всё же он не из титана. И даже не из чугуна. Он такой же человек с такими же эмоциями, переживаниями и, как оказалось, таким тяжёлым прошлым». Но на этом моя рефлексия прервалась, и я провалился в сон. В эту ночь меня уже ничто не тревожило."
