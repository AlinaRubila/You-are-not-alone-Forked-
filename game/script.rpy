...
label start:
    ...
    "Он, как неприятное воспоминание, пробрался ко мне в мысли непрошенным гостем. Многое произошло за последнее время, только почему-то вспоминалось одно лишь плохое: прощания, переезд, от чего-то вся заплаканная мама, а ещё чуть раньше последний Новый Год…"
