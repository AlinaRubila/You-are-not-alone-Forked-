...
label start:
    ...
    "Они маленькие, совсем хрупкие, аккуратно садятся мне на нос, щёки, ресницы и тут же тают. От каждого этого мимолётного \"поцелуя\" зимы я ощущаю, как по спине бегут мурашки, разнося по всему телу незаметно забравшийся под куртку мороз."

    "Он, как неприятное воспоминание, пробрался ко мне в мысли непрошенным гостем. Многое произошло за последнее время, только от чего-то вспоминалось только всё плохое: прощания, переезд, от чего-то вся заплаканная мама, а ещё чуть раньше последний Новый Год…"
    ...
    "Где-то в глубине непроглядной темноты я почувствовал чьё-то еле уловимое присутствие."

    "Ну, как присутствие… Может ли кто-то \"присутствовать\" прямо в небе?"
    ...
    "Около правого уха раздался незнакомый мне звонкий женский голос."

    "Я сразу представил раскрасневшееся от холода лицо той девушки, которая решила подойти к такому странному человеку, как я, стоящему на одном месте, словно истукан."
    ...
    "Я все ещё не мог пошевелиться. Мороз будто цепями сковал моё тело, но и девушка не спешила подойти и посмотреть мне в лицо."
    ...
    "Конечно, для меня это не самый первый день в универе. Но это первый день на пути к моей мечте! Прошлый университет был отстойным, да и профессия не моя. Зато теперь я точно знаю, в каком направлении двигаться!"
    ...
    "С соседом надо бы нормально познакомиться. Какой-то он угрюмый… И в комнате было не убрано, когда я заезжал. Как ни приду, он спит. Может, работает? И почему он не просыпается на пары, ведь уже пора? Но будить я его побаиваюсь…"
    ...
    "Зимний холодный воздух ударил мне в лицо, неприятно покалывая на щеках. Дорога из общаги в университет была мне пока не знакома, но я осознал, что ещё много раз побываю на ней."
    ...
    "Лишь спустя десять минут я зашёл в нужное здание. Но на этом загадки не закончились."
