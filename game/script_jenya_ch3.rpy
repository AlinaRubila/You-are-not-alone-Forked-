...
label jenya_cp3:
    ...
    play music morning
    #Фон окошко из комнаты Гг.
    #такого нет - есть просто коната
    scene bg_room_dawn with dissolve

    "Время идет, пришла весна, как пелось в одной известной песне «чумачечая»."
    ...
    #Спрайт гг в повседневной одежде с улыбкой
    ...
    #Смена музыки на тишину. Плавный переход.
    ...
    #Спрайт Гг смущённый
    show mc sada at left2 with dissolve #здесь не подойдёт обычное смущение - тут скорее стыд за неудачную шутку
    ...
    #Смена фона на коридор универа.
    scene bg_uni_evening  with dissolve #похоже на вечер по смыслу
    #Смена музыки на обычную.
    play music base

    show jenya normal smilea at right2 with dissolve

    #Спрайт Жени в повседневной одежде с улыбкой
    j "Ты с Тимуром так и не поговорил нормально?"

    show mc sada at left2 with dissolve

    #Спрайт Гг в повседневной одежде смущённый
    ...
    #Фон затемняется
    scene black with dissolve
    #Появляется фон комната гг, утро
    ...
    #На экране отдельный выбор действия.
    #Отдельный cj рисуночки блинчиков и овсяной каши.
    ...
    if favorite_food:
        ...
        #Спрайт Жени в пижаме, улыбается.
        ...
        #Спрайт уставшей, сонной Жени в пижаме.
    ...
    #Смена фона на комнату Гг.
    scene bg_room_evening with dissolve
    "Я вернулся домой. Переживания за Женю сменились рутинной учёбой."
