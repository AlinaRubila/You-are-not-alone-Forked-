...
label timur:
    ...
    "Вода окутывала меня теплом и успокаивающим шумом. Я позволил себе расслабиться под тёплыми струями, пытаясь смыть с себя все негативные мысли и страхи, которые преследовали меня после странного сна."

    "Я не понимал, к чему мне это снится, но принятие душа действительно давало успокаивающий эффект."
    ...
    scene cj_unpacking with dissolve #добавить цг с диска
